#!/usr/bin/env python3
"""Evaluate the frozen ESCI subset across retrieval backends."""
...
RUN_MANIFEST = Path("benchmarks/manifests/esci.json")
OUTPUT_DIR = Path("data/evaluation/esci_backends")
